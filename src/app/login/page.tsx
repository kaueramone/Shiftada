      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-10">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-gray-500 mt-2 text-base">
            Plantões médicos, direto ao ponto.
          </p>
        </div>
        ...
        <div className="w-full max-w-sm space-y-3 mb-10">
          {[
            { icon: '🏥', text: 'Encontre plantões na sua cidade' },
            { icon: '📋', text: 'Anuncie seu plantão em segundos' },
        ...
        {/* Error message */}
        {error && (
          <div className="w-full max-w-sm mb-4 bg-red-50 border border-red-200 rounded-xl px-4 py-3">
        ...
        <div className="w-full max-w-sm space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold py-4 px-6 rounded-2xl transition-colors text-base"
          >
